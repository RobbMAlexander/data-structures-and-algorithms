...
const addOne = (arr) => {
  ...
  arr.forEach(value => {
    ...
    incrementedArr.push(incrementedValue);
  });
...
const addExclamation = (arr) => {
  ...
  arr.forEach(value => {
    let emphasizedValue = value + '!';
    emphasizedArr.push(emphasizedValue);
  });
  return emphasizedArr;
};
...
const allUpperCase = (arr) => {
  ...
  arr.forEach(value => {
    capsArr.push(value.toUpperCase());
  });
  return capsArr;
};
...
const speaker = (words, callback) => {
  ...
  words.forEach(value => {
    let spoken = callback(value);
    speakerArr.push(spoken);
  });
  return speakerArr;
};
...
const addNumbers = (num, arr, times, callback) => {
  let addNumbersArr = arr;

  for (let i = 0; i < times; i++) {
    callback(addNumbersArr, num);
  }
  return addNumbersArr;
};
